...
typedef enum SignalDrop {
   ...
   /*counter sample clock source pins*/
...
typedef class  BufferedEventCounterCtrl  BufferedEventCounterCtrl;
typedef class  BufferedPwMeterCtrl       BufferedPwMeterCtrl;
typedef class  BufferedUdCounterCtrl     BufferedUdCounterCtrl;
typedef class  BufferedPwModulatorCtrl   BufferedPwModulatorCtrl;
#endif
...
typedef CounterIndexer<SignalDrop>        CounterSampleClockSourceIndexer;
...
public:
   ...
   CounterSampleClockSourceIndexer* getEcSampleClockSources()        { return (CounterSampleClockSourceIndexer*)CntrFeatures_getEcSampleClockSources(this);  }
   CounterSampleClockSourceIndexer* getPiSampleClockSources()        { return (CounterSampleClockSourceIndexer*)CntrFeatures_getPiSampleClockSources(this);  }      
   CounterSampleClockSourceIndexer* getPoSampleClockSources()        { return (CounterSampleClockSourceIndexer*)CntrFeatures_getPoSampleClockSources(this);  }
   CounterSampleClockSourceIndexer* getUdSampleClockSources()        { return (CounterSampleClockSourceIndexer*)CntrFeatures_getUdSampleClockSources(this);  }
